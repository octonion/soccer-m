...
ncaa_play_by_play << [
  ...
  "team_text","team_score","opponent_score","score","opponent_text"]
...
#        print "sleep #{sleep_time} ... "
      ...
      page.xpath(play_xpath).each_with_index do |row,event_id|
        ...
        ncaa_play_by_play << [game_id,period_id,event_id,time,team_text,team_score,opponent_score,score,opponent_text]
      end
