...
./scrape_ncaa_year_division.sh 2015 1
./scrape_ncaa_year_division.sh 2015 2
./scrape_ncaa_year_division.sh 2015 3
...
./scrape_ncaa_year_division.sh 2012 2
./scrape_ncaa_year_division.sh 2012 3
./scrape_ncaa_year_division.sh 2011 1
